angular.module("AnimeApp", [])
    .controller("MainController", ['$http', function($http) {
        ...
        main.getDay = function() {
            ...
            $http.get('https://api.nasa.gov/neo/rest/v1/feed?start_date=2016-10-08&end_date=2016-10-14&api_key=inFehaJWogK6MJMMdjpHf7GVLaXd9ZUUoASwbBBt')
                .success(function(data) {
