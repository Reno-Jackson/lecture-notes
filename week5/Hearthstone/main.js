...
function deckController($http, $routeParams) {
    ...
    deckCtrl.grabCards = function(charClass) {
        ...
        if (charClass === "Warrior") {
            ...
            deckCtrl.goldPortraits = "./golden-portraits/garrosh.png";
            deckCtrl.heroPower = "./hero-powers/warrior.png";
            deckCtrl.classDesc = "Garrosh Hellscream is the current Warchief of the Horde, chosen by Thrall to succeed him in the wake of the Shattering. Garrosh grew up on Draenor in the shadow of his father, the great warrior Grommash Hellscream. Chieftain of the Warsong clan, Grom was the first orc leader to drink the blood of Mannoroth, subjugating the orcs to the Legion’s will. Before this event, Garrosh was among several orcs who had become ill with the red pox. They had been quarantined far away in Nagrand, allowing them to escape the demonic corruption. The younger Hellscream was ashamed of his father for many years until he met Thralland learned of Grom’s heroic redemption. Garrosh has since embraced his potential as a strong leader, most notably in Northrend, where he directed the Horde advance through the Borean Tundra and won the hearts of his people. Uncompromising and fiercely proud, Garrosh intends to restore the orcs’ glory by any means necessary. While presiding over the renewed war against the Alliance, Garrosh's increasingly brutal reign has evoked direly strained relations within the Horde itself. Garrosh's ultimate fate will be explored as the war on Pandaria reaches its climax, where he will find himself dealing with both his hated enemy and an uprising within his own ranks.";
        } else if (charClass === "Shaman") {
            deckCtrl.classBackground = "./images/thrall.png";
            deckCtrl.goldPortraits = "./golden-portraits/thrall.png";
            deckCtrl.heroPower = "./hero-powers/shaman.png";
            deckCtrl.classDesc = "Thrall (birthname Go'el), son of Durotan, is the former Warchief of the restored shamanistic Horde, and founder of the red land of Durotar in Kalimdor. After the fall of the Lich King and the increasing elemental unrest heralding the Shattering, Thrall stepped down as leader of the Horde, appointed Garrosh Hellscream as Warchief, and joined with the Earthen Ring to combat the rampaging elements.With his victory over the corrupted aspect behind him, Thrall has been forced to deal with the chaos his replacement has sewn in his wake. Garrosh, whose reinvigorated war has fundamentally changed the Horde Thrall had once envisioned, stands on the brink of burgeoning rebellion from within his own ranks, and Thrall steps back in to defend the Horde and its allies from their increasingly ruthless dictator. Together with Vol'jin and other disenfranchised leaders of the Horde, Thrall plans to overthrow his ill-fated successor."
        } else if (charClass === "Rogue") {
            deckCtrl.classBackground = "./images/valeera.png";
            deckCtrl.goldPortraits = "./golden-portraits/valeera.png";
            ...
            deckCtrl.goldPortraits = "./golden-portraits/jaina.png";
            deckCtrl.heroPower = "./hero-powers/mage.png";
            deckCtrl.classDesc = "Lady Jaina Proudmoore is the leader of the Kirin Tor and ruler of Dalaran. She is the daughter of Grand Admiral Daelin Proudmoore and sister of Derek Proudmoore. As such she is Princess of the Kingdom of Kul Tiras, although she never uses the title. Jaina was one of the most trusted sorceresses of Dalaran, trained as the personal agent of the Archmage Antonidas, leader of the Kirin Tor. Early in the Third War, Antonidas dispatched Jaina to discover what was happening in the northlands of Lordaeron. She was escorted by her childhood friend and one-time romantic interest, Prince Arthas Menethil, to uncover if the plague had magical origins. Jaina saw the fall of Lordaeron firsthand and — guided by a mysterious prophet — rallied what survivors she could and fled across the sea to Kalimdor. Jaina swore to defeat the Burning Legion and its sinister agents any way she could. Joining forces with the night elves and even the orcish Horde, Jaina helped defeat the demon Archimonde and banish the Legion. She then gathered the human survivors in Kalimdor and founded the port city of Theramore Isle, where she ruled over the tattered remnants of the Alliance and hoped to reunite the distant human kingdoms once more. Shortly after the fall of Deathwing, the Horde, under orders from Warchief Garrosh Hellscream, unleashed a devastating attack against Theramore, destroying the city. Jaina managed to escape with her life, but the experience transformed her, making her more bellicose and even altering her appearance. Following the death of Rhonin during the attack, and fulfilling a prophecy made by the dragon-mage Korialstrasz, Jaina took the fallen mage's place as leader of the Kirin Tor."
        } else if (charClass === "Priest") {
            deckCtrl.classBackground = "./images/anduin.png";
            deckCtrl.goldPortraits = "./golden-portraits/anduin.png";
            deckCtrl.heroPower = "./hero-powers/priest.png";
            deckCtrl.classDesc = "Crown Prince Anduin Llane Wrynn is the heir to the throne of Stormwind. He is named after two venerated figures of Stormwind history: the legendary Anduin Lothar and his grandfather King Llane."
        }
